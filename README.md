...
La versión [v1.1.5](https://github.com/jumanor/refirmainvoker/tree/v1.1.5) es el último lanzamiento
...
Se compilo *Refirma Invoker Integration* para Windows y Linux, y estan disponibles en los [releases](https://github.com/jumanor/refirmainvoker/releases/tag/v1.1.5).

1. Descargue el ejecutable
   
   Windows: [main.exe](https://github.com/jumanor/refirmainvoker/releases/download/v1.1.5/main.exe)
   
   Linux:   [main](https://github.com/jumanor/refirmainvoker/releases/download/v1.1.5/main)
